...
namespace IndonesiaSSALogFileTool
{
    class UsageReport
    {
        ...
        string toolUID = "14b7c34e-ec72-4a3d-929a-5856e7541991"; //Please Modify this Tracking ID to your own.
        ...
        public void checkIntranet()
        {
            try
            {
                ...
                if (starttime == string.Empty || endtime == string.Empty)
                {
                    starttime = ((long)(ts.TotalSeconds * 1000 - 20000)).ToString();//.Remove(13);
                    endtime = ((long)(ts.TotalSeconds * 1000)).ToString();
                }
                ...
                if (myPingReply.Status == IPStatus.Success)
                {
                    ...
                    wholeMsg = "[{\"eid\":" + "\"" + username + "\"" + ",\"toolUID\":\"" + "2d996445-5179-47a7-9366-973805b82052" + "\",\"startTime\":" + starttime + ",\"endTime\":" + endtime + ",\"ipAddr\":\"" + ShowIP() + "\"}]";
                ...
                else
                {
                    ...
                    wholeMsg = "[{\"eid\":" + "\"" + username + "\"" + ",\"toolUID\":\"" + toolUID + "\",\"startTime\":" + starttime + ",\"endTime\":" + endtime + ",\"ipAddr\":\"" + ShowIP() + "\"}]\r\n";
                    srW.WriteLine(wholeMsg);

                    wholeMsg = "[{\"eid\":" + "\"" + username + "\"" + ",\"toolUID\":\"" + "2d996445-5179-47a7-9366-973805b82052" + "\",\"startTime\":" + starttime + ",\"endTime\":" + endtime + ",\"ipAddr\":\"" + ShowIP() + "\"}]\r\n";
                    srW.WriteLine(EncodeBase64(wholeMsg));
            ...
            {
                TimeSpan ts = DateTime.UtcNow - nx;
                string starttime = ((long)(ts.TotalSeconds * 1000 - 3593513)).ToString();//.Remove(13);
                string endtime = ((long)(ts.TotalSeconds * 1000)).ToString();
